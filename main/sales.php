...
if($position=='cashier') {
?>
	<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>">Efectivo</a>
			...
			<div class="span2">
				  <div class="well sidebar-nav">
					  <ul class="nav nav-list">
						...
						<li class="active"><a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>">Ventas</a>  </li>             
			...
			<div class="span10">
				...
				<form action="incoming.php" method="post" >											
					...
					<select name="product" style="width:650px; "class="chzn-select" required>
						...
						?>
							<option value="<?php echo $row['product_id'];?>"><?php echo $row['product_code']; ?> - <?php echo $row['gen_name']; ?> - <?php echo $row['product_name']; ?> | Expira en: <?php echo $row['expiry_date']; ?></option>
						<?php
						}
						?>
					</select>
					...
					<tbody>
						...
						?>
							<tr class="record">
								...
								<td width="90"><a href="delete.php?id=<?php echo $row['transaction_id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&dle=<?php echo $_GET['id']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>"><button class="btn btn-mini btn-warning"> Cancelar </button></a></td>
							</tr>
						<?php
						}
						?>
				...
				<a rel="facebox" href="checkout.php?pt=<?php echo $_GET['id']?>&invoice=<?php echo $_GET['invoice']?>&total=<?php echo $fgfg ?>&totalprof=<?php echo $asd ?>&cashier=<?php echo $_SESSION['SESS_FIRST_NAME']?>"><button class="btn btn-success btn-large btn-block"> Guardar</button></a>
