...
<link href="css/estiloAddLedger.css" media="screen" rel="stylesheet" type="text/css" />
<form action="saveledger.php" method="post">
	...
	<div id="ac">
		<span>cantidad : </span><input type="text" id= "amount" name="amount" /><br>
		<span>Observaciones : </span><input type="text" id="obs" name="remarks" /><br>
